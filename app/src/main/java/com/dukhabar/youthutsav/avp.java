 ...
 */
public class avp extends Fragment {

        private final String LOG_TAG = getClass().getSimpleName();
        private int Position;
        private String[]   developer_name , developer_image , developer , developer_mobile , developer_email , fbprofile;
        private TextView developer_name_tv , developer_work;


        public avp(int Position)
        {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            return inflater.inflate(R.layout.avp, container, false);
        }
